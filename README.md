...
![FNVMA System Interface](archived/menuUI.png) *The FNVMA frontend featuring real-time, force-directed network graph visualization of the semantic vector space.*
